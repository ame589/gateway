package it.eng.gateway.repository;

import it.eng.gateway.GatewayApp;

import it.eng.gateway.config.Constants;
import it.eng.gateway.config.audit.AuditEventConverter;
import it.eng.gateway.domain.PersistentAuditEvent;
...
import static it.eng.gateway.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;

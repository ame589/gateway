package it.eng.gateway.web.rest;

import it.eng.gateway.GatewayApp;
import it.eng.gateway.config.Constants;
import it.eng.gateway.domain.User;
import it.eng.gateway.repository.AuthorityRepository;
import it.eng.gateway.repository.UserRepository;
import it.eng.gateway.security.AuthoritiesConstants;
import it.eng.gateway.service.UserService;
import it.eng.gateway.service.dto.PasswordChangeDTO;
import it.eng.gateway.service.dto.UserDTO;
import it.eng.gateway.web.rest.vm.KeyAndPasswordVM;
import it.eng.gateway.web.rest.vm.ManagedUserVM;
...
import static it.eng.gateway.web.rest.AccountResourceIT.TEST_USER_LOGIN;
